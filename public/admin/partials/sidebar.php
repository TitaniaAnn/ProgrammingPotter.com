<aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
        ...
        <div class="admin-nav__section">Beta App</div>
        <a href="/admin/beta/index.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/beta/') ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2L2 7l10 5 10-5-10-5z"/><path d="M2 17l10 5 10-5"/><path d="M2 12l10 5 10-5"/></svg>
            Overview
        </a>
        <a href="/admin/beta/testers.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 00-3-3.87"/><path d="M16 3.13a4 4 0 010 7.75"/></svg>
            Testers
        </a>
        <a href="/admin/beta/feedback.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
            Feedback
        </a>
        <a href="/admin/beta/email.php" class="admin-nav__item">
