<aside class="admin-sidebar">
    ...
    <nav class="admin-nav">
        <a href="/admin/dashboard.php" class="admin-nav__item <?= basename($_SERVER['PHP_SELF']) === 'dashboard.php' ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="3" width="7" height="7"/><rect x="14" y="3" width="7" height="7"/><rect x="3" y="14" width="7" height="7"/><rect x="14" y="14" width="7" height="7"/></svg>
            Dashboard
        </a>
        <div class="admin-nav__section">Orders</div>
        <a href="/admin/orders/index.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
            All Orders
        </a>
        <div class="admin-nav__section">Events</div>
        <a href="/admin/events/index.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/events/') ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            All Events
        </a>
        <a href="/admin/events/add.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Add Event
        </a>
        <div class="admin-nav__section">Announcements</div>
        <a href="/admin/announcements/index.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/announcements/') ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z"/></svg>
            All Announcements
        </a>
        <a href="/admin/announcements/add.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Add Announcement
        </a>
        <div class="admin-nav__section">Portfolio</div>
        <a href="/admin/pottery/index.php" class="admin-nav__item">
        ...
        <a href="/admin/pottery/add.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Add Piece
        </a>
        <div class="admin-nav__section">Shop</div>
        <a href="/admin/shop/index.php" class="admin-nav__item">
        ...
        <a href="/admin/shop/add-product.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Add Product
        </a>
        <div class="admin-nav__section">Social</div>
        <a href="/admin/social/index.php" class="admin-nav__item">
        ...
        <a href="/admin/social/links.php" class="admin-nav__item">
        ...
        <a href="/admin/social/tokens.php" class="admin-nav__item">
        ...
        <a href="/admin/templates/index.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/templates/') ? 'active' : '' ?>">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/></svg>
            All Templates
        </a>
        <a href="/admin/templates/add.php" class="admin-nav__item">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="12" y1="5" x2="12" y2="19"/><line x1="5" y1="12" x2="19" y2="12"/></svg>
            Add Template
        </a>
        <div class="admin-nav__section">Settings</div>
        <a href="/admin/settings/index.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/settings/index.php') ? 'active' : '' ?>">
        ...
        <a href="/admin/settings/schema-health.php" class="admin-nav__item <?= str_contains($_SERVER['PHP_SELF'], '/admin/settings/schema-health.php') ? 'active' : '' ?>">
    ...
    <div class="admin-sidebar__footer">
        ...
        <a href="/admin/logout.php" class="admin-sidebar__logout">Sign Out</a>
    </div>
</aside>
